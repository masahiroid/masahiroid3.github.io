 ...
 ***********************************************************************/
function __sprite_6() { 
__sprite_init__(this, sprite_6, 80, 40, 40, 20, 'Box', 40, 0, 80, 0, 40, ['img/sprite_6_0.png']);
}; var sprite_6 = new __sprite_6();
 ...
 * OBJECTS
 ***********************************************************************/
function __object_button_1() {
__instance_init__(this, object_button_1, null, 1, 0, sprite_6, 1, 0);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, object_button_1)) {
	appendScript();
	}
}
};
...
}; var object_button_1 = new __object_button_1();
...
this.objects = [
[{o:object_button_1, x:240, y:220}]];
this.start = function() {
__room_start__(this, scene_3, 480, 480, 30, 128, 128, 0, null, 0, 0, 0, 480, 480, null, 50, 50);
};
}
